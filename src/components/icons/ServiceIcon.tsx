...
const iconPaths: Record<string, string> = {
  "id-card":
    "M4 4a2 2 0 012-2h8a2 2 0 012 2v16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 4h2v2H6V8zm0 4h2v2H6v-2zm4-4h4v2h-4V8zm0 4h4v2h-4v-2zm2 4h2v2h-2v-2z",
  shield:
    "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
  "credit-card":
    "M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z",
  vote: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
  car: "M8 7h8m-8 4h8m-4 6v2m-4 0v-2m12-2V9a2 2 0 00-2-2h-2.5l-1.5-3A2 2 0 0010.5 2h-1A2 2 0 007.5 4L6 7H4a2 2 0 00-2 2v9a2 2 0 002 2h12a2 2 0 002-2z",
...
export function ServiceIcon({ name, className = "w-10 h-10" }: ServiceIconProps) {
  const path = name && iconPaths[name] ? iconPaths[name] : iconPaths["receipt"];
