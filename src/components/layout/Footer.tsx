      ...
      <Container>
        <div className="py-12 lg:py-16">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-12">
            <div>
              <h3 className="text-lg font-semibold text-white">Sharma Solutions</h3>
              <p className="mt-3 text-sm text-slate-400 leading-relaxed">
                Your Trusted CSC Service Center. Government services made easy.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm">
                ...
                <li className="max-w-xs text-slate-400">{CSC_CONTACT.address}</li>
              </ul>
            </div>
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-white">
          ...
          <div className="mt-12 border-t border-slate-800 pt-8 text-center text-sm text-slate-400">
            © {new Date().getFullYear()} Sharma Solutions. All rights reserved.
          </div>
        </div>
      </Container>
    </footer>
